...
def get_user_username(instanse: "Profile") -> str:
    return instanse.user.username
...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+6281212345678"
    )
    country_of_origin = CountryField(verbose_name=_("Country"), default="ID")
    city_of_origin = models.CharField(
        verbose_name=_("City"), max_length=180, default="Jakarta"
    )
